...
namespace VividRasV2.Controllers
{
    public class LanguagesController : Controller
    {
        ...
        public LanguagesController(MovieReviewContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Languages != null ? 
                          ...
                          Problem("Entity set 'MovieReviewContext.Languages'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MovieReviewContext.Languages'  is null.");
            }
            var language = await _context.Languages.FindAsync(id);
            if (language != null)
            {
        ...
        {
          return (_context.Languages?.Any(e => e.LangId == id)).GetValueOrDefault();
        }
    }
}
